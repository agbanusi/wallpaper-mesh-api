...
import replicate
from dalle import enhance_prompt 
# import torch
...
def generate_image_text_first_source(prompt, height, width, image=None):
  ...
  prompt = "Generate a description of "+prompt+", highly detailed, 4k, 8k, uhd, ultra realistic, digital art, photo, illustration, elegant, hyperrealistic, concept art, dramatic lighting"
